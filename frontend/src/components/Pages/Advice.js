        ...
        return (
            <div  className="advicecontainer">
                <div className = "titleblock">
                    <h1 className = "title" align='center'>Student Advice - Tips from current and former students on how to succeed in computer science</h1>
                </div>
                <div style={{padding:"40px"}} >
                    <p style={{fontSize:"20px"}}>
                        <strong>Why do CS students enjoy the major?</strong>
                    </p>
                    <p className = "answer" style = {{fontSize: "18px"}}>
...
.
                ...
                <div className = "link" style ={{padding:"20px"}}>
                    <a href = "https://docs.google.com/forms/d/e/1FAIpQLSetOfhGcQ-hXzH84-i3MZrpls-REl2PyOpOQJbF3dHGrKPEXg/viewform?usp=sf_link">Got advice you want 
                    to give? Submit here</a>
                </div>
